    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='biblioteka', to='biblioteka.author', verbose_name='autorius')),
                ('genre', models.ManyToManyField(help_text='isrinkite zanra(us) siai knygai', to='biblioteka.genre')),
            ],
        ),
    ]
